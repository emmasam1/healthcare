    ...
    <div>
      ...
      <div className="text-center mt-10 md:px-20 lg:px-32">
        ...
        <p className="text-base sm:text-lg text-justify">
          <b>Amazing & Steadfast Residential Agency Inc.</b> is your locally
          owned and trusted source for healthcare. At Amazing & Steadfast
          Residential Agency Inc, we provide quality homecare services that
          include: companionship, meal preparation, personal care, bath
